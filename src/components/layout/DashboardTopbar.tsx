...
export function DashboardTopbar() {
  return (
    <header className="sticky top-0 z-30 flex h-16 shrink-0 items-center gap-x-4 border-b border-white/10 bg-background/60 backdrop-blur-xl px-4 sm:gap-x-6 sm:px-6 lg:px-8">
      {/* Mobile menu button */}
      ...
      <div className="flex flex-1 items-center gap-x-4 lg:gap-x-6">
        ...
        <div className="flex flex-1">
          <div className="relative w-full max-w-md hidden sm:block">
            ...
            <input
              type="text"
              placeholder="Cari janji, politisi, atau laporan..."
              className="h-10 w-full rounded-full border border-white/10 bg-white/5 pl-10 pr-4 text-sm text-white placeholder:text-white/40 focus:border-primary/50 focus:outline-none focus:ring-1 focus:ring-primary/50 transition-all"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-x-4 lg:gap-x-6">
          <button type="button" className="-m-2.5 p-2.5 text-white/60 hover:text-white relative">
            ...
            <span className="absolute top-2.5 right-3 h-2 w-2 rounded-full bg-primary animate-pulse"></span>
          </button>
