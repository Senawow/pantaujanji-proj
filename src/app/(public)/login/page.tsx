...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center pt-24 pb-12 px-4 relative overflow-hidden">
      ...
      <div className="absolute top-[20%] left-[20%] w-[40vw] h-[40vw] rounded-full bg-primary/10 blur-[100px] pointer-events-none mix-blend-screen" />
      <div className="absolute bottom-[20%] right-[20%] w-[30vw] h-[30vw] rounded-full bg-secondary/10 blur-[100px] pointer-events-none mix-blend-screen" />
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-heading font-bold text-2xl text-white mb-2">Selamat Datang Kembali</h1>
          <p className="text-white/60 text-sm">Masuk untuk melaporkan progress janji politik.</p>
        </div>
        ...
        <div className="glass-card rounded-3xl p-8 border border-white/10 relative overflow-hidden">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#0a0a0a] px-2 text-white/40">Atau masuk dengan email</span>
            </div>
          </div>
